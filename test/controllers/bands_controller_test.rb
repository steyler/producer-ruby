...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { name_band: @band.name_band, start_date: @band.start_date, type: @band.type } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { name_band: @band.name_band, start_date: @band.start_date, type: @band.type } }
